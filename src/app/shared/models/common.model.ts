...
export class ImageFile {
  ...
  public tag = 0;
  public fileTick: string = null;
  public creationDate: string =  GlobalConstants.serverDate?GlobalConstants.serverDate.toLocaleDateString():new Date().toLocaleDateString();
  public creationTime: string = GlobalConstants.serverDate?GlobalConstants.serverDate.toLocaleTimeString():new Date().toLocaleTimeString();
}
