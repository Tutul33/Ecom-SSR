...
export class Table implements OnInit, AfterViewInit, AfterContentInit, BlockableUI, OnChanges {
    ...
    constructor(public el: ElementRef, public zone: NgZone, public tableService: TableService, public cd: ChangeDetectorRef, public filterService: FilterService, public overlayService: OverlayService, @Inject(PLATFORM_ID) private platformId: any,) { }
...
export class TableBody implements AfterViewInit, OnDestroy {
    ...
    constructor(public dt: Table, public tableService: TableService, public cd: ChangeDetectorRef, public el: ElementRef,@Inject(PLATFORM_ID) private platformId: Object) {
...
export class SortableColumn implements OnInit, OnDestroy {
    ...
    constructor(public dt: Table,@Inject(PLATFORM_ID) private platformId: Object) {
        if (this.isEnabled()) {
...
export class SelectableRow implements OnInit, OnDestroy {
    ...
    constructor(public dt: Table, public tableService: TableService,@Inject(PLATFORM_ID) private platformId: Object) {
        if (this.isEnabled()) {
...
export class ResizableColumn implements AfterViewInit, OnDestroy {
    ...
    constructor(public dt: Table, public el: ElementRef, public zone: NgZone,@Inject(PLATFORM_ID) private platformId: Object) { }
...
export class TableRadioButton {
    ...
    constructor(public dt: Table, public tableService: TableService, public cd: ChangeDetectorRef,@Inject(PLATFORM_ID) private platformId: Object) {
        this.subscription = this.dt.tableService.selectionSource$.subscribe(() => {
    ...
    template: `
        ...
        <ng-template #builtInElement>
            <ng-container [ngSwitch]="type">
                ...
                <p-calendar *ngSwitchCase="'date'" dateFormat="dd-M-y" (ngModelChange)="onModelChange($event)" [ngModel]="filterConstraint?.value"></p-calendar>
            </ng-container>
        </ng-template>
    `,
    encapsulation: ViewEncapsulation.None,
            ...
            <div *ngIf="showMenu && overlayVisible" [ngClass]="{'p-column-filter-overlay p-component p-fluid': true, 'p-column-filter-overlay-menu': display === 'menu'}" (click)="onContentClick()"
                ...
                <ng-template #menu>
                    <div class="p-column-filter-operator" *ngIf="isShowOperator">
                        <p-dropdown appendTo="body" appendTo="body" appendTo="body" [options]="operatorOptions" [ngModel]="operator" (ngModelChange)="onOperatorChange($event)" styleClass="p-column-filter-operator-dropdown"></p-dropdown>
                    </div>
                    <div class="p-column-filter-constraints">
                        <div *ngFor="let fieldConstraint of fieldConstraints; let i = index" class="p-column-filter-constraint">
                            <p-dropdown appendTo="body" appendTo="body" appendTo="body"  *ngIf="showMatchModes && matchModes" [options]="matchModes" [ngModel]="fieldConstraint.matchMode" (ngModelChange)="onMenuMatchModeChange($event, fieldConstraint)" styleClass="p-column-filter-matchmode-dropdown"></p-dropdown>
...
export class ColumnFilter implements AfterContentInit {
    ...
    constructor(public el: ElementRef, public dt: Table, public renderer: Renderer2, public cdr: ChangeDetectorRef, public config: PrimeNGConfig, public overlayService: OverlayService,@Inject(PLATFORM_ID) private platformId: Object) { }
