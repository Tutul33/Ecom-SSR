...
import { BaseComponent, GlobalConstants, GlobalMethods, ProviderService } from "../..";
import {
  ColumnType,
  ExportOption,
...
import { RowToggler, Table, TableService } from "../table/table";
...
export class NiTableComponent extends BaseComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  invokePdfService(nativEl: any, values: any, columns?: any[]) {
    ...
    this.dynamicReportSvc.exportPdfFunction(this.exportOption, isNestedReport,true);//this.grid.exportOption.isUnicodeSupported
  }
