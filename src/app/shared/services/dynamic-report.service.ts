...
export class DynamicReportService {
  ...
  exportPdfFunction(exportOptionParam: ExportOptionInterface, isNestedReport: boolean,isUnicodeSupported?:boolean) {
    if (isPlatformBrowser(this.platformId)) {
    ...
    import('jspdf').then(jsPDF => {     
      import('jspdf-autotable').then(x => {
        ...
        this.headerFooterFormatting(doc, doc.getNumberOfPages());
  ...
  private headerFooterFormatting(doc, totalPages) {
