...
export class HttpErrorHandler {
    ...
    constructor(private messageService: MessageService,private router: Router,private _http: HttpClient, public onlineOfflineSvc: OnlineOfflineService) { }
        ...
        switch (error.status) 
        {
            ...
            case 0:
                if(!this.isCheckOnlineIntervalAssigned){
                    this.onlineOfflineSvc.updateServerOnlineStatus(false);
                    this.checkOnline();
                }
