...
export class Config {
  ...
  static url = {
    ...
    // itmLocalUrl: gl.ERP_MODULES_URL.itmLocalUrl,
    // slsLocalUrl: gl.ERP_MODULES_URL.slsLocalUrl,
    // gsLocalUrl: gl.ERP_MODULES_URL.gsLocalUrl,
    // rptLocalUrl: gl.ERP_MODULES_URL.rptLocalUrl,
    // rptReportFileUrl: gl.ERP_MODULES_URL.rptReportFileUrl,
    // invLocalUrl: gl.ERP_MODULES_URL.invLocalUrl,
    // invReportFileUrl: gl.ERP_MODULES_URL.invReportFileUrl,
    // hrmLocalUrl: gl.ERP_MODULES_URL.hrmLocalUrl,
    ecomLocalUrl: gl.ERP_MODULES_URL.ecomLocalUrl,
    ecomReportFileUrl: gl.ERP_MODULES_URL.ecomLocalUrl
  ...
  static marketingPageConfig = {
    RewardPointSetup: 1,
    MembershipConfiguration: 2,
    AutomaticCouponDisbursement: 3,
  };
}
